...
1. Branding / stylescapes  
   ...
   — You may use Claude Code for this.
...
— Double-check that everything is accessible from incognito mode. Otherwise, your submission will be discarded.  
— All deliverables should be in English.  
— You should record a video presentation of your work in English using Loom, FocuSee, or a similar tool.  
